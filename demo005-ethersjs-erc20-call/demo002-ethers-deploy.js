...
const App = {
    ...
    deployContract: async function () {
        try {
            const signer = new ethers.Wallet(PrivateKey, provider);
            factory = new ethers.ContractFactory(contractMyTestAbi, contractMyTestBytecode, signer);
            ...
            await contract.deployTransaction
                ...
                .then(txReceipt => {
                    ...
                    console.log('new contract txhash: ', contract.deployTransaction.hash);
                })
                .catch(err => {
                    console.log(err);
                });
...
var contractMyTestBytecode = parsed.bytecode;
